...
export const lineExpressions: LineExpression[] = [
  { id: 'soft-refusal-today', surface: '今日はちょっと厳しいかな', literalMeaning: 'Oggi è un po’ difficile, forse.', naturalMeaning: 'Oggi per me è un po’ complicato; forse non riesco.', subtext: 'La frase esprime una difficoltà attenuata. Da sola non dimostra che si tratti di un rifiuto definitivo.', tones: ['soft', 'hesitant', 'casual'] },
  { id: 'postpone-next-time', surface: 'また今度ね', literalMeaning: 'Un’altra volta, la prossima volta, eh.', naturalMeaning: 'Facciamo un’altra volta, va bene?', subtext: 'Può rimandare un’occasione con tono amichevole; non garantisce che l’invito verrà ripreso.', tones: ['soft', 'casual'] },
  { id: 'enjoyed-today', surface: '今日は楽しかった', literalMeaning: 'Oggi è stato divertente.', naturalMeaning: 'Oggi mi sono divertito/a.', subtext: 'Esprime una valutazione positiva dell’esperienza; la frase non identifica da sola il rapporto tra le persone.', tones: ['casual'] },
  ...
  { id: 'understood', surface: 'わかった', literalMeaning: 'Ho capito.', naturalMeaning: 'Va bene, ho capito.', tones: ['casual', 'direct'] },
